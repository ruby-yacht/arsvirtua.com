...
<title>Demand Player Sovereignty Resources</title>
</head>
...
<div class="content">
 <h1>Demand Player Sovereignty Resources</h1><br />
 
 We encourage remote participation and welcome individuals to come join us in our protest efforts. DPS will be making instructions and resources available over the next few months.<br />
 <br />
 <br />
<!-- <h2> Interface Addons</h2>
<br />
These Addons allow a player to become a questgiver.  When installed by both the giver and receiver, custom quests and achievements can be created. The actions, operations and interface looks the same to the quest recipient as any normal quests and achievements would.
(Humans stealing jobs from NPCs)<br />
<br />
Developed by Marek Kapolka (Lead Researcher)<br />
<br />
To Install:<br />
Download <a href="http://wow.curseforge.com/addons/player-quests/files/2-r7/" target="_blank">Player Quests  Addon</a> and <a href="http://wow.curseforge.com/addons/alternate-achievements/files/2-r3/" target="_blank">Alternative Achievements Addon</a>
<br />
Place the files in your wow addon interface folder.<br />
<br />

To Create a Quest:<br />
<br />

To Offer a Quest:<br />
<br />

To Trigger Quest Completion:<br /><br />

Please provide any and all useful feedback to <a href="mailto:mkapolk@gmail.com">Marek Kapolka</a> of <a href="http://thirdfaction.org/blog/?p=471" target="_blank">H.E.R.D Research</a><br />
<br />
<br /> -->
...
<br />
High resolution stickers for your downloading and printing pleasure. These stickers are given out at many DPS interventions as part of real-wold quest-lines.<br /><br />
<table border="0" cellpadding="10"><tr>
<td><a href="resources/handshake.png" target="_blank">
<img src="resources/thumb/handshake.png" width="120" /><br />
DPS Handshake</a></td>

<td><a href="resources/3f_logo.png" target="_blank">
<img src="resources/thumb/3f_logo.png"  width="120" /><br />
3rd Faction Logo</a></td>
<td><a href="resources/dps_crest.png" target="_blank">
<img src="resources/thumb/dps_crest.png"  width="120" /><br />
DPS Crest</a></td>
</tr></table>
