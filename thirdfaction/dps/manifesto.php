...
<title>Demand Player Sovereignty: A Manifesto For Avatar Rights</title>
</head>
...
<div class="content">
 <h1>Demand Player Sovereignty: A Manifesto for Avatar Rights</h1>

<blockquote><em>A community that does not know the standards by which the administrators use their power is a community which permits its administrators to have no standards, and is therefore a community abetting in tyranny...The community has the right to require of every administrator or individual with special powers and privileges granted for the purpose of administration, an account of his administration. This relates to accountability and transparency. A virtual community in which the observance of the code of conduct is not assured and universal, nor the separation of powers defined, has no constitution at all.</em><br /><br />
<div align="right">- Raph Koster, A Declaration of the Rights of Avatars, Aug 2000</div></blockquote>
<br />


 <h3>The avatar is an extension of a geophysically-defined person </h3> who embodies and inherits rights specified in The Universal Declaration of Human Rights (U. D. H. R.). Avatars manifest their physical counterparts or users. The Avatar is not simply a software representation devoid of agency.<br />
   <br />
   We recognize that administrators, code, databases, and hardware fulfill the role of caretakers in game environments. They form an indispensable architecture within which consistent game engagement itself is manufactured. This becomes ineffectual without the full interaction and interplay of the user, the avatar, and the community.<br />
   <br />
   <h3>We demand a voice:</h3>
   <br />
   We demand the right to reflect on the underlying code and architecture on which a game environment is constructed.<br />
   <br />
   We demand open dialogue with the corporate stakeholders.<br />
   <br />
   We demand participatory real-time engagement and feedback according to a dynamic game structure.<br />
   <br />
   We demand self governance:<br />
  <br />
   We demand standards of behavior and enforcement that are created by the community.<br />
  <br />
   We demand standards that apply to administration, particularly in disciplinary-related actions.<br />
  <br />
   We demand corporate reflection on the greater implications of avatar and human-user rights in the public sphere.<br />
  <br />
   <h3>We demand transparency:</h3>
   <br />
   We demand Terms of Service (T. O. S.) that are written in plain-language.<br />
  <br />
   We demand T. O. S. that do more than protect the hosting corporation.<br />
  <br />
   We demand codified acknowledgment that &ldquo;clicking through&rdquo; the T. O. S. does not automatically indicate a manufacturing of user or avatar consent.<br />
  <br />
   <h3>We reject:</h3>
   <br />
   We reject flawed game narratives that harm our community.<br />
  <br />
   We reject narratives that conflict with self evident game-dependent truths and fail to support the in-world history.<br />
  <br />
   We reject that avatars and users can cede their synthetic rights. The same principles should be inferred to avatars as are in the U. D. H. R.  <br />
  <br />
   <h3>We resolve:</h3>
   <br />
   We resolve to create a code of conduct that embraces the diversity of our community as an ongoing open process of avatar self-governance.<br />
  <br />
   We resolve to remain an open and transparently governed body in pursuit of positive change for the community and game environs in general.<br />
  <br />
   Signed:<br />
  <br />
  <h3><em>Third Faction</em></h3>
