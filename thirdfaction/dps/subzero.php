...
<title>Demand Player Sovereignty at SubZERO</title>
...
<ul>
<h3><a href="/dps">DPS</a></h3>
<li><a href="manifesto.php">Manifesto</a></li>
<li><a href="/blog">Blog Posts</a></li>
<li><a href="subzero.php">SubZER0</a></li>
<li><a href="http://isea2011.sabanciuniv.edu/workshop/dps-demand-player-sovereignty-0" target="_blank">ISEA 2011 →</a></li>
...
<div class="content">
 <h1>Demand Player Sovereignty at SubZERO</h1><br />
 On June 3, 2011 Demand Player Sovereignty hosted a real-world field
station at the 4th Annual <a href="http://www.subzerofestival.com/" target="_blank">SubZERO Festival</a>.  SubZERO is a yearly
street fair in downtown San Jose that focuses on emerging and present
subcultures in the silicon valley/bay area. Specifically those with a homebrew, mashup, and techno-art bent. Our field agents operated as quest givers during the festival, both on the ground and in the World of Warcraft.<br />
<br />

<iframe src="http://player.vimeo.com/video/27757335?title=0&amp;portrait=0&amp;color=ff9933" width="600" height="450" frameborder="0"></iframe><br /><br />

<blockquote><em>The business on the other side of the curtain went fine. Being a
  quest giver was boring, as would be  expected, but playing dynamically
  and helping players complete the quest made it slightly more
  interesting. Protip for player quest givers: don’t play like an NPC.</em>
  - Marek Kapolka</blockquote>

The quests were DIY alternatives to those mind-numbing hack and slash
adventures in tedium normally found in-game and acted as a reaction to
the standard kill x number for blank enemy.  The real world quest was
to make a new friend. The participant had to place a Third Faction
sticker on a new found friend, then either take a picture with them or
bring them back to the field station. The virtual quest was to help
wow players on opposing sides of the in-game war become friends. This
was facilitated by a software addon developed in house. This addon mimicked
the games natural mechanics and interface. Thus allowing a member of
DPS to seamlessly usurp the role of an in-game quest giver. Completing
these alternative quest lines allowed ‘players’ to gain reputation
with DPS. If both quests were completed the participant was awarded a
Third Faction badge designed and created specifically for this event.<br /><br />


DPS was successful in its goal or raising awareness about fabricated
conflicts, virtual and otherwise, as well as, the need for governmental
transparency. However, reactions to the event were mixed and this foray
into real life intervention acted as a learning experience for us as
well.
<br />
<br />
<a href="img/crew.jpg" rel="shadowbox[subzero]" title="Third Faction Crew"><img src="img/thumb/crew.jpg" alt="Third Faction Crew" /></a><a href="img/mike_interv.jpg" rel="shadowbox[subzero]" title="Michael Amundsen and the local press"><img src="img/thumb/mike_interv.jpg" alt="Michael Amundsen and the local press" /></a><a href="img/vera_mike.jpg" rel="shadowbox[subzero]" title="learning the ropes"><img src="img/thumb/vera_mike.jpg" alt="learning the ropes" /></a><a href="img/flyer_shot.jpg" rel="shadowbox[subzero]" title="flyers and badges"><img src="img/thumb/flyer_shot.jpg" alt="flyers and badges" /></a><a href="img/jenene.jpg" rel="shadowbox[subzero]" title="Jenene gives out real life quests"><img src="img/thumb/jenene.jpg" alt="Jenene gives out real life quests" /></a>

<br />
<blockquote><em>Even within the gaming community, WoW is a polarizing game. It is
  subject to many stereotypes- fat nerds  poopsocking for days, trycares
  getting buttmad about losing their e-swag, the horrible, horrible
  barrens  chat, the manipulative pavlovian mechanics (wowcrack). Just
  about everyone has played it (or knows  someone who has), and just
  about everyone has quit. So not only was the number of people who knew
  about  the game limited, but half of those who did were very quick to
  dismiss the project on sight, simply  because of the game in which it
  took place.</em><br /> 
  - Marek Kapolka</blockquote>

<blockquote><em>Personally I wanted to see how the public would respond to a piece
that was both in game and in real life. Overall I think people
responded well to it, but only if it was explained to them. Otherwise
people seemed to see the monitors showing a “video game” and just on
passed by without a second glance. However, when people began talking
to us they became more intrigued with the project, but many were still
reluctant to participate in game because of the interface barrier. We
did receive positive feedback from those who did talk with us.</em> -
Jenene Castle</blockquote>

 Field Agents:<br />
Michael Amundsen, Jenene Castle, Sara Gevurtz, Marek Kapolka, Ali Sajjadi, Liz Solo, Thomas Asmuth<br /><br />

Custom Addon Programming and Development:<br />
Marek Kapolka<br /><br />

Additional Camera Work:<br />
Kyungwha Lee
