...
<title>Ars Virtua: Not a Hero (in the traditional sense)</title>
<script language="JavaScript" type="text/javascript">
<!--
function movload(vidnum)
{
	tag = ['<object width="425" height="355"><param name="movie" value="http://www.youtube.com/v/LeKU0bVAps4&rel=1"></param><param name="wmode" value="transparent"></param><embed src="http://www.youtube.com/v/LeKU0bVAps4&rel=1" type="application/x-shockwave-flash" wmode="transparent" width="425" height="355"></embed></object>','<object width="425" height="355"><param name="movie" value="http://www.youtube.com/v/1XvNv0S2rKI&rel=1"></param><param name="wmode" value="transparent"></param><embed src="http://www.youtube.com/v/1XvNv0S2rKI&rel=1" type="application/x-shockwave-flash" wmode="transparent" width="425" height="355"></embed></object>'];
	
	document.getElementById('vid').innerHTML = tag[vidnum];
}
//-->
</script>
...
<h3>About the Work</h3><br />
   ...
   Not a Hero (in the traditional sense) is an experiment in roleplaying. Dave, is the character I become. For me, Dave embodies the fantasy of the banal. He lives in a world of paperwork and office politics not demon slaying and magic. I perceive Dave as the fantasy character's fantasy. He doesn't have to worry about warring factions or situations of life or death. Like many Americans, his life is simple and his big problems are trivial in the grand scheme of things. Dave isn't unaware of the violence and war going on in the world in which he lives, it simply doesn't directly affect him. To Dave the undead are mythical but deadlines are all to real.<br />
   <br />
When I play as Dave, I play strictly in character. I must treat the World of Warcraft as the only world I know. I must acknowledge conversation with all other characters, regardless of how they role. A common challenge when rolplaying in MMORPGS like Warcraft is reconciling those users playing out of character. Dave lives in Twisting Nethers, a detected role playing server, however, the amount of actual roleplay on the server is still collectively up to the users. Even playing on a dedicated server, those playing in character inevitably end up in the minority. Thus, in playing Dave, I not only have the challenge of reconciling those chatting out of character but I also have to reconcile those characters playing traditional fantasy roles.  Dave must take in the world around him as any one of us would, and thus he assumes those around him share his context. If questioned, Dave does know a lot about dragons, because he wastes a lot of time at work on Wikipedia.<br />
<br />
<!--<div class="spacer_gray"></div><br />

<h3>Dave's Video Journal</h3><br />
Filming Dave is essentially the same as filming a reality TV series. I have to record hours and hours of footage. Then comb through it.<br />
-->
</div>
<div class="c2">
  <a href="images/id_lore.jpg" target="_blank"><img src="images/thumb/id_lore.jpg" alt="dave" width="264" height="212" border="0" /></a>
<div class="title">Identity and Lore</div>
<a href="images/hi.png" target="_blank"><img src="images/thumb/hi.jpg" alt="dave" width="264" height="165" border="0" /></a><br />
<!--<a href="images/gothkids.png"><img src="images/thumb/gothkids.jpg" alt="goth kids" width="264" height="176" border="0" /></a><br />
<a href="images/hotel.png"><img src="images/thumb/hotel.jpg" alt="my hotel" width="264" height="176" border="0" /></a><br /> -->
<a href="images/sleep2.png" target="_blank"><img src="images/thumb/sleep2.jpg" alt="dave in bed" width="264" height="198" border="0" /></a><br />
<a href="images/meeting1.png" target="_blank"><img src="images/thumb/meeting1.jpg" alt="dave meeting" width="264" height="165" border="0" /></a><br />
<a href="images/warm.png" target="_blank"><img src="images/thumb/warm.jpg" alt="skulcrusher" width="264" height="198" border="0" /></a><br />
  <div class="title">Photos  from Dave </div>
</div>
<div class="c1" style="width:100%;background:#e9e9e9; padding-top:10px; margin:20px 0 20px 0">
<div id="vid" style="float:left; padding:0 20px 10px 10px">
<object width="425" height="355"><param name="movie" value="http://www.youtube.com/v/LeKU0bVAps4&rel=1"></param><param name="wmode" value="transparent"></param><embed src="http://www.youtube.com/v/LeKU0bVAps4&rel=1" type="application/x-shockwave-flash" wmode="transparent" width="425" height="355"></embed></object>
</div>
<h3>Dave's Video Journal</h3><br />

<a href="javascript:movload(0)">Day 1 Part 1</a><br />
<a href="javascript:movload(1)">Day 1 Part 2</a><br />
<a href="log1.html" target="_blank">Day 1 Chatlog</a><br />
<br />
<br />
